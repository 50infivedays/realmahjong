...
export const Navbar = () => {
    ...
    // In-game specific navbar logic
    if (pathname === '/game') {
        return (
            <>
                {/* Desktop Navbar (Visible on md+, hidden on mobile) */}
                <nav className="hidden md:flex fixed top-0 left-0 right-0 z-50 h-16 bg-green-900/95 backdrop-blur-sm border-b border-green-800 shadow-lg items-center justify-between px-4 sm:px-8 text-white">
                    {/* Left: Logo and Title */}
                    <Link
                        href="/"
